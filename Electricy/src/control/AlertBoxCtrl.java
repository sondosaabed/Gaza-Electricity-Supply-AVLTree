...
public class AlertBoxCtrl {
	 ...
	 * @param title
	 */
	public AlertBoxCtrl(String meassage,String title, boolean warn) {
		initialize(meassage,title, warn);
	}
	 ...
	 * @param title
	 */
	private void initialize(String meassage, String title, boolean warn) {
		setScene(new AlertBoxScene(warn));
